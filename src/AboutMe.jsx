...
const REVEAL_CONTENT = [
  {
    upper: ["Spandan Upamanyu", "Entrepreneur • Web Developer • Startup Builder"],
    lower: "Spandan Upamanyu is an aspiring entrepreneur and web developer with a strong interest in startups, digital products, UI/UX, branding, SEO, and modern web development. He focuses on creating visually appealing, user-centric, and high-performance web experiences while continuously exploring innovative business opportunities.",
  },
  {
    upper: ["Aspiring entrepreneur & web developer", "Focused on modern, high-performance digital experiences"],
    lower: "Passionate about startups, product development, UI/UX, branding, SEO, and creating premium web experiences using modern technologies.",
  },
  {
    upper: ["Assamese (Native)", "Hindi (Fluent)", "English (Fluent)"],
    lower: "fluent in multiple languages, enabling strong collaboration, communication, and global perspective.",
  },
];
...
const ITEMS = [
  {
    id: "about", label: "ABOUT ME", handle: "@spanhex", href: "https://github.com/spanhex", icon: "👤", barIcon: icon1, bars: 1, newBars: [0], counts: ["ACTIVE"],
    links: ["github.com/spanhex"],
    stats: [
      { tag: "NAME", value: "SPANDAN", color: "#e8c100" },
      { tag: "ROLE", value: "BUILDER", color: "#4a8fff" },
    ],
  },
  {
    id: "bio", label: "SHORT BIO", handle: "@spanhex", href: "https://github.com/spanhex", icon: "📝", barIcon: icon2, bars: 1, newBars: [0], counts: ["ACTIVE"],
    links: ["github.com/spanhex"],
    stats: [
      { tag: "FOCUS", value: "STARTUPS", color: "#e1306c" },
      { tag: "TECH", value: "WEB DEV", color: "#f77737" },
    ],
  },
  {
    id: "languages", label: "LANGUAGES", handle: "@spanhex", href: "https://github.com/spanhex", icon: "🌐", barIcon: icon3, bars: 1, newBars: [0], counts: ["ACTIVE"],
    links: ["github.com/spanhex"],
    stats: [
      { tag: "LANG", value: "3 SPOKEN", color: "#00f2ea" },
      { tag: "NATV", value: "ASSAMESE", color: "#ff0050" },
    ],
  },
];
