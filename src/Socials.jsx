...
const ITEMS = [
  {
    id: "github", label: "GITHUB", handle: "@spanhex", href: "https://github.com/spanhex", icon: "💻", barIcon: icon1, bars: 1, newBars: [0], counts: ["PROJ"],
    links: ["github.com/spanhex"],
    stats: [
      { tag: "PRJ", value: "ACTIVE", color: "#9147ff" },
      { tag: "DEV", value: "SPANHEX", color: "#bf94ff" },
    ],
  },
  {
    id: "instagram", label: "INSTAGRAM", handle: "@notshousuke", href: "https://www.instagram.com/notshousuke/", icon: "📷", barIcon: icon2, bars: 1, newBars: [0], counts: ["SOCIAL"],
    links: ["instagram.com/notshousuke"],
    stats: [
      { tag: "IG", value: "SHOUSK", color: "#e1306c" },
      { tag: "BIO", value: "SPANDAN", color: "#f77737" },
    ],
  },
];
